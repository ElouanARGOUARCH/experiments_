...
for i in range(number_runs):
    ...
    real_nvp = MixedModelDensityEstimator(target_samples,[[RealNVPDensityEstimatorLayer,[128,128,128]],[RealNVPDensityEstimatorLayer,[128,128,128]]])
    ...
    filename = 'runs_rnvp/runs_euler_rnvp' + str(i) + '.sav'
